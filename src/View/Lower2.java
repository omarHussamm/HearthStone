...
public class Lower2 extends JPanel {
	...
	private Lower2Listener listener;

	// private Lower1 listener1;
	...
	private void helper() {
		try {
			...
			System.out.println("error from lower 2");
		}
		listener.StartPlay();
		listener.play();
	...
	public Lower2Listener getListener() {
		return listener;
	}

	public void setListener(Lower2Listener listener) {
