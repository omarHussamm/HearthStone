...
public class Minion extends Card implements Cloneable {
	...
	public String getCardStats() {
		return "<html>" + getName() + "<br>" + getRarity() + "<br>"
				+ "Attack: " + attack + "<br>" + "HP" + currentHP + "/" + maxHP
				+ "<br>" + "Mana Cost: " + getManaCost() + "<br>" + "Taunt: "
				+ isTaunt() + "<br>" + "Divine: " + isDivine() + "<br>"
				+ "Attacked: " + isAttacked() + "<br>" + "Charge: "
				+ !isSleeping() + "</html>";
	}
}
