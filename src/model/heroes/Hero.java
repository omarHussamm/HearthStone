...
public abstract class Hero implements MinionListener {
	...
	public void useHeroPower() throws NotEnoughManaException,
		...
		heroPowerUsed = true;
		System.out.println("heropowerused");
	}
	...
	public void attackWithMinion(Minion attacker, Minion target)
		...
		System.out.println("Minion attacked minion");
		listener.updateGame();
	}
	...
	public void attackWithMinion(Minion attacker, Hero target)
		...
		validator.validateAttack(attacker, target);
		attacker.attack(target);
		System.out.println("Minion attacked Hero");
		listener.updateGame();
	}
	...
	public String getHeroStats() {
		return "<html>" + name + "<br>" + "HP: " + currentHP + "/30" + "<br>"
				+ "Mana Crystals" + currentManaCrystals + "/"
				+ totalManaCrystals + "</html>";
	}
